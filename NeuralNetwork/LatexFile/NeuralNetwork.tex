...
\begin{document}
    ...
    \hypertarget{implementaciuxf3n-red-neural}{%
\section{Implementación Red Neural}\label{implementaciuxf3n-red-neural}}
...
\end{tcolorbox}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
1672/1672 [==============================] - 57s 34ms/step - loss: 4.0742e-04
    \end{Verbatim}

            \begin{tcolorbox}[breakable, size=fbox, boxrule=.5pt, pad at break*=1mm, opacityfill=0]
\prompt{Out}{outcolor}{79}{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
<tensorflow.python.keras.callbacks.History at 0x7fa8e54d4850>
\end{Verbatim}
\end{tcolorbox}
...
\end{tcolorbox}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
<ipython-input-85-578636ed339f>:4: SettingWithCopyWarning:
